...
public class mahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FTI", "Hukum", "Teknik", "Psikologi" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "nama", "nim", "jurusan", "alamat", "telpon"
            }
        ));
...
// menampilkan data kedalam form pengisian:
        ...
        telpon1.setText(telp);        // TODO add your handling code here:
    }//GEN-LAST:event_jTable1MouseClicked

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       try {
            String sql ="UPDATE mhs SET nama = '"+nama1.getText()+"', nim = '"+nim1.getText()+"', jurusan = '"+jComboBox1.getSelectedItem()+"',alamat= '"+alamat1.getText()+"',phone= '"+telpon1.getText()+"' WHERE nim = '"+nim1.getText()+"'";
            java.sql.Connection conn=(Connection)config.configDB();
            java.sql.PreparedStatement pst=conn.prepareStatement(sql);
            pst.execute();
